                                    ...
                                    <div className="row row-cols-auto">
                                        <div className="form-group col">
                                            <div class="text-center">
                                                <img src="https://data.whicdn.com/images/156615160/original.png" className="rounded img" alt="..." />
                                                <input type="hidden" className="form-control form-control-sm" id="img" value="32000"/>
